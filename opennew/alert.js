...
/*弹出修改房屋信息的窗口页面*/
function OpenEditHourse(index, title, hourseId) {
    current_index = index;
    var diag = new Dialog("Diag1");
    diag.Width = 600;
    diag.Height = 350;
    diag.Title = title == null ? "修改房屋信息" : title;
    diag.URL = "hourse/hourse_modify.aspx?hourseId=" + encodeURI(hourseId);
    diag.Message = "<span style='color:red'>请修改房屋信息</span>";
    diag.ShowMessageRow = true;
